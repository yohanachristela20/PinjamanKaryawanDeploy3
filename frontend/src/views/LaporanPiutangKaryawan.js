...
import {
 ...
 function LaporanPiutang() {
  ...
  const header = ["id_pinjaman", "tanggal_pengajuan", "jumlah_pinjaman", "jumlah_angsuran", "pinjaman_setelah_pembulatan", "keperluan", "id_peminjam", "id_asesor", "sudah_dibayar", "belum_dibayar", "bulan_angsuran", "status"];
